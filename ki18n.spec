...
Source0  : https://download.kde.org/stable/frameworks/5.101/ki18n-5.101.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.101/ki18n-5.101.0.tar.xz.sig
...
%prep
%setup -q -n ki18n-5.101.0
cd %{_builddir}/ki18n-5.101.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671050908
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5I18nLocaleData.so.5.101.0
