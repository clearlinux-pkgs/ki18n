...
%prep
%setup -q -n ki18n-5.70.0
cd %{_builddir}/ki18n-5.70.0
...
cp %{_builddir}/ki18n-5.70.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/ki18n/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/ki18n-5.70.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/ki18n/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
%find_lang ki18n5
...
/usr/lib64/libKF5I18n.so.5.70.0
