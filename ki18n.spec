...
Source0  : https://download.kde.org/stable/frameworks/5.60/ki18n-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/ki18n-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563039471
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5I18n.so.5.60.0
