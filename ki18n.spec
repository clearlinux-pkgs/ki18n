...
Source0  : https://download.kde.org/stable/frameworks/5.67/ki18n-5.67.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.67/ki18n-5.67.0.tar.xz.sig
...
%prep
%setup -q -n ki18n-5.67.0
cd %{_builddir}/ki18n-5.67.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581278609
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ki18n-5.67.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/ki18n/095d1f504f6fd8add73a4e4964e37f260f332b6a
cp %{_builddir}/ki18n-5.67.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/ki18n/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang ki18n5
...
/usr/lib64/libKF5I18n.so.5.67.0
