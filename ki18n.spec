...
Source0  : https://download.kde.org/stable/frameworks/6.6/ki18n-6.6.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.6/ki18n-6.6.0.tar.xz.sig
...
%setup -q -n ki18n-6.6.0
cd %{_builddir}/ki18n-6.6.0
pushd ..
cp -a ki18n-6.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726443688
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6I18n.so.6.6.0
/V3/usr/lib64/libKF6I18nLocaleData.so.6.6.0
...
/usr/lib64/libKF6I18n.so.6.6.0
/usr/lib64/libKF6I18nLocaleData.so.6
/usr/lib64/libKF6I18nLocaleData.so.6.6.0
