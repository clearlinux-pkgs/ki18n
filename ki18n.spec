...
Source0  : https://download.kde.org/stable/frameworks/6.10/ki18n-6.10.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.10/ki18n-6.10.0.tar.xz.sig
...
%setup -q -n ki18n-6.10.0
cd %{_builddir}/ki18n-6.10.0
pushd ..
cp -a ki18n-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736521152
mkdir -p clr-build
pushd clr-build
...
/usr/include/KF6/KI18n/KLocalizedQmlContext
...
/usr/include/KF6/KI18n/ki18nqml_export.h
...
/usr/include/KF6/KI18n/klocalizedqmlcontext.h
...
/usr/lib64/libKF6I18nQml.so

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6I18n.so.6.10.0
/V3/usr/lib64/libKF6I18nLocaleData.so.6.10.0
/V3/usr/lib64/libKF6I18nQml.so.6.10.0
...
/usr/lib64/libKF6I18n.so.6.10.0
/usr/lib64/libKF6I18nLocaleData.so.6
/usr/lib64/libKF6I18nLocaleData.so.6.10.0
/usr/lib64/libKF6I18nQml.so.6
/usr/lib64/libKF6I18nQml.so.6.10.0
