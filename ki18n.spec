...
Source0  : https://download.kde.org/stable/frameworks/5.100/ki18n-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/ki18n-5.100.0.tar.xz.sig
...
%prep
%setup -q -n ki18n-5.100.0
cd %{_builddir}/ki18n-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668446506
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5I18n.so.5.100.0
/usr/lib64/libKF5I18nLocaleData.so.5
/usr/lib64/libKF5I18nLocaleData.so.5.100.0
