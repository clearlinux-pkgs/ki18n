...
Source0  : https://download.kde.org/stable/frameworks/6.13/ki18n-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/ki18n-6.13.0.tar.xz.sig
...
%setup -q -n ki18n-6.13.0
cd %{_builddir}/ki18n-6.13.0
pushd ..
cp -a ki18n-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744638912
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6I18n.so.6.13.0
/V3/usr/lib64/libKF6I18nLocaleData.so.6.13.0
/V3/usr/lib64/libKF6I18nQml.so.6.13.0
...
/usr/lib64/libKF6I18n.so.6.13.0
/usr/lib64/libKF6I18nLocaleData.so.6
/usr/lib64/libKF6I18nLocaleData.so.6.13.0
/usr/lib64/libKF6I18nQml.so.6
/usr/lib64/libKF6I18nQml.so.6.13.0
